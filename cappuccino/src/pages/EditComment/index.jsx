  ...
  return (
    <>
      <div className="bg-gray-300 flex flex-col font-inter gap-[34px] items-center justify-start mx-auto p-[34px] sm:px-5 w-full">
        {/* <Navbar className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1419px] mx-auto pb-[7px] pl-[7px] md:px-5 w-full" /> */}
        <Navbar
        ...
        />
        <AllideasScreen
          className="bg-white-A700 flex flex-col items-start justify-start max-w-[958px] mb-[5px] mx-auto p-[39px] md:px-5 rounded-[20px] w-full"

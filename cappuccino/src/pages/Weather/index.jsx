        ...
        <div className="your-comments-screen">
            <div className="comment-screen-header">
                ...
                <button
                    ...
                    className="bg-blue-500 text-white px-6 py-3 mt-4 rounded-lg hover:bg-blue-700 text-center flex items-center"
                    > Get Weather in Your Area
                </button>
                </div> {/* new comment button */}
            </div> {/* comment-screen-header */}
            ...
            {weather && (
                ...
                <div className="mt-4 flex flex-row flex-wrap gap-4 justify-center p-12" >
